        ...
        <Card className="bg-destructive/10 border-destructive/30 backdrop-blur-xl">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Ineligible (&lt; 75% Attendance)</div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-black/20 border border-white/5 flex flex-col gap-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Generate and distribute hall tickets to all eligible students.</p>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 rounded-lg bg-black/20 border border-white/5">
                ...
                <Badge variant="outline" className="text-primary text-sm px-3 py-1">75%</Badge>
              </div>
              ...
              <div className="flex justify-between items-center p-3 rounded-lg bg-black/20 border border-white/5">
                ...
                <Badge variant="outline" className="text-sm px-3 py-1">End-Semester</Badge>
              </div>
              ...
              <div className="flex justify-between items-center p-3 rounded-lg bg-black/20 border border-white/5">
                ...
                <div className="w-10 h-5 bg-destructive/20 rounded-full flex items-center p-1 border border-destructive/50">
