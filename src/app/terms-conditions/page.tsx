    ...
    <div style={{ minHeight: '100vh', background: '#050505', color: '#fff', padding: '40px 20px', fontFamily: 'var(--font-sans)' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', background: 'rgba(255,255,255,0.03)', border: '1px solid var(--glass-border)', borderRadius: '16px', padding: '40px' }}>
        ...
        <div style={{ color: 'var(--text-muted)', lineHeight: 1.8 }}>
          ...
          <p style={{ marginBottom: '15px' }}>By accessing and using Campus OS, you agree to comply with and be bound by these Terms and Conditions. These terms apply to all students, faculty, administrators, and staff of the institution.</p>
          ...
          <p style={{ marginBottom: '15px' }}>The institution reserves the right to suspend or terminate your access to Campus OS if you are found to be violating these terms, engaging in academic dishonesty, or manipulating the placement tracking system.</p>
        </div>
      </div>
    </div>
  );
